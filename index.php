...
$wa->registerAndUseStyle($assetColorName, 'media/templates/site/fooo/css/global/' . $paramsColorName . '.css');
...
?>">
	...
	<?php if ($this->params->get('backTop') == 1) : ?>
		<a href="#top" id="back-top" class="back-to-top-link" aria-label="<?php echo Text::_('TPL_FOOO_BACKTOTOP'); ?>">
